...
import { Menu, Home, Users, FileText, Activity, LogOut } from 'lucide-react'; 

// ======================================================================
// 🧩 ส่วนประกอบ: SIES Logo 
// ======================================================================
...
// ======================================================================
// 🧩 ส่วนประกอบ: Sidebar Component
// ======================================================================
// 🛑 เพิ่มเมนู Member สำหรับ Officer
const navItems = [
  { text: 'Home', path: '/officer/home', icon: Home },
  { text: 'Member', path: '/officer/member', icon: Users },
  { text: 'File', path: '/officer/files', icon: FileText }, 
  { text: 'Assessment Activity', path: '/officer/activity', icon: Activity },
];
...
const NotificationPanel = () => {
  ...
  const sampleNotifications = [
    { id: 1, text: 'ระบบตรวจสอบพบผู้ใช้งานใหม่ลงทะเบียน 3 ราย', time: '10 นาทีที่แล้ว' },
    { id: 2, text: 'มีเอกสารที่รอการอนุมัติ (Pending Approval)', time: '2 ชั่วโมง' },
    { id: 3, text: 'อัปเดตระบบฐานข้อมูลประจำสัปดาห์สำเร็จ', time: '1 วัน' },
  ];
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <header className="flex justify-between items-center p-3 sm:p-4 bg-white shadow-md relative z-10">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            {/* User Profile - เปลี่ยนเป็นสีน้ำเงินเพื่อแสดงความต่าง Role */}
            <div 
            ...
            >
              ...
              <div className="w-9 h-9 sm:w-10 sm:h-10 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold shadow-sm flex-shrink-0">
                O
              </div>
            </div>
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto p-4 sm:p-6">
          {/* 🛑 ส่งตัวแปร isSidebarOpen ผ่าน Context ไปให้หน้าลูก */}
