// src/pages/Student/Component/DashboardSection.jsx
...
return (
 // 🛑 นี่คือ Card ใหญ่ (กรอบนอก) ที่เราต้องการให้สูงเต็ม
 ...
 <div className="flex justify-center mb-6">
  ...
  style={{
   ...
   boxShadow: '0 0 0 10px #f0f9ff inset',
  }}
  ></div>
 </div>

 {/* Legend (แก้ไข: จัดแนวนอน, เปอร์เซ็นต์อยู่ด้านล่างกึ่งกลาง) */}
 ...
 <div className="mb-4">
  <h4 className="text-red-600 font-medium mb-2">Not Submitted (3)</h4>
 ...
 <div>
  <h4 className="text-blue-800 font-medium mb-2">Submitted (1)</h4>
  <div className="bg-gray-50 rounded-md p-3"> 
  <ul className="text-sm text-gray-700 space-y-1">
