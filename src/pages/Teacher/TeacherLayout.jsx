...
// ======================================================================
const navItems = [
  { text: 'Home', path: '/teacher/home', icon: Home },
  { text: 'File', path: '/teacher/files', icon: FileText }, 
  { text: 'Assessment Activity', path: '/teacher/activity', icon: Activity },
];
...
const NotificationPanel = () => {
  ...
  const sampleNotifications = [
    { id: 1, text: 'นักศึกษา Teenoi 1 ส่งงาน "การบ้านบทที่ 5" แล้ว', time: '10 นาทีที่แล้ว' },
    { id: 2, text: 'มีประชุมภาควิชาเวลา 13:00 น. ห้องประชุม 2', time: '1 ชั่วโมง' },
    { id: 3, text: 'แจ้งเตือนส่งเกรดภายในวันศุกร์นี้', time: '1 วัน' },
  ];
    ...
    <div className="flex bg-gray-100 min-h-screen">
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto p-4 sm:p-6">
          {/* 🛑 อัปเดตที่นี่: ส่งตัวแปร isSidebarOpen ผ่าน Context ลงไปให้ลูกๆ ใช้งานได้ */}
